...
<body>
		...
		<div class="container">
			<div class="container-fluid">
				<div class="navbar-header">
			      ...
			      <a class="navbar-brand" href="#">酒仙网</a>
			    </div>
	...
	<div class="container">
			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-primary">
					...
					<div class="panel-collapse collapse in" id="panel1">
						<ul class="list-group">
						  <li class="list-group-item"><a href="user/select.php">会员查看</a></li>
						  <li class="list-group-item"><a href="user/add.php">会员添加</a></li>
						</ul>
					</div>
				</div>
				<!-- 广告管理 -->
		...
		<div class="col-md-10">
			<div class="thumbnail">
		      <img src="holder.js/100%x350" alt="...">
		      <div class="caption">
		        <h3>会员管理</h3>
		        <p>所有会员</p>
		        <p>
		        	<a href="index.php" class="btn btn-primary" role="button">返回首页</a> 
		        	<a href="logon.php" class="btn btn-default" role="button">退出系统</a>
		        </p>
		      </div>
		    </div>
		</div>
