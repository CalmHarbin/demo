...
//分页效果实现
$sql1="select count(*) from keywords";
...
$sql="select * from keywords order by frequency desc limit {$page->idx},{$page->num}";
$smt=$pdo->prepare($sql);
$smt->execute();
$rows=$smt->fetchAll();
 ?>
...
<body>
	<div class="thumbnail">
			...
			<p class="pull-right" id="sum">当前关键字个数:<span><?php echo $sum; ?></span></p>
			<?php 
				echo $page->show;
			 ?>
    </div>
